...
-- Step 1: Create new azure_devices table with reordered columns
...
INSERT INTO azure_devices_reordered (
    ...
    last_sign_in_date, account_enabled, compliance_expiration_date, device_version,
    is_rooted, mdm_app_id, profile_type, trust_type, on_premises_sync_enabled,
    on_premises_last_sync_date, created_at, last_updated
)
SELECT 
    tenant_id, device_id, device_name, model, operating_system, os_version,
    device_ownership, is_compliant, is_managed, manufacturer, compliance_state,
