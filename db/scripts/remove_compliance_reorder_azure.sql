...
-- Step 1: Create new azure_devices table with reordered columns and without compliance_state
...
-- Step 2: Copy data from existing azure_devices table (excluding compliance_state)
INSERT INTO azure_devices_reordered (
    ...
    account_enabled, compliance_expiration_date, device_version,
    is_rooted, mdm_app_id, profile_type, trust_type, on_premises_sync_enabled,
    on_premises_last_sync_date, last_sign_in_date, created_at, last_updated
)
SELECT 
    tenant_id, device_id, device_name, model, operating_system, os_version,
    device_ownership, is_compliant, is_managed, manufacturer,
